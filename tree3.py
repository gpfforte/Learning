...
import pandas as pd
from servizio.classi import My_Treeview
...
if __name__ == '__main__':
    ...
    my_frame1 = ttk.Frame(root, borderwidth=5, padding=5).pack(fill='both')
    listbox = My_Treeview(my_frame1)

    def empty_tree():
        listbox.update_data(df_empty)

    def fill_tree():
        listbox.update_data(df_sample)
